...
class DocumentProcessor:
    ...
    async def generate_claude_tasks(self, pdf_paths: List[str], project_name: Optional[str] = None) -> Dict[str, Any]:
        """Generate only Claude Code tasks"""
        return await self.process_documents(pdf_paths, project_name, output_format="tasks")
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        output_writable = output_dir.parent.exists() and os.access(output_dir.parent, os.W_OK)
        ...
        return {
            ...
            "system_ready": (
                len(config_issues["errors"]) == 0 and
                any(provider_status.values()) and
                output_writable
            )
        }
    ...
    def get_system_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "configuration": {
                ...
                "include_documentation": self.config_manager.config.generation.include_documentation
            },
            "framework_preferences": self.config_manager.config.generation.framework_preferences
        }
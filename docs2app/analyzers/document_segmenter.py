...
class DocumentSegmenter:
    ...
    def __init__(self):
        ...
        self.section_patterns = {
            'ziele': [
                r'ziele?', r'objectives?', r'goals?', r'zweck', r'purpose',
                r'vision', r'mission'
            ],
            'anforderungen': [
                r'anforderungen?', r'requirements?', r'spezifikation',
                r'specification', r'bedingungen', r'conditions'
            ],
            'features': [
                r'features?', r'funktionen?', r'functions?', r'capabilities',
                r'eigenschaften', r'merkmale'
            ],
            'technisch': [
                r'technisch', r'technical', r'architektur', r'architecture',
                r'implementation', r'implementierung', r'system', r'infrastruktur'
            ],
            'user_stories': [
                r'user stor(y|ies)', r'anwendungsfälle', r'use cases?',
                r'szenarien', r'scenarios?', r'workflows?'
            ],
            'api': [
                r'api', r'schnittstelle', r'interface', r'endpoints?',
                r'services?', r'rest', r'graphql'
            ],
            'daten': [
                r'daten', r'data', r'database', r'datenbank', r'modell',
                r'model', r'schema', r'entities'
            ]
        }
